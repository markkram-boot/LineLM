...
def inference(iteration, map_dir, map_name, model_epoch=100, cuda=1):
    ...
    if iteration == 0:
        model_weight_path = f"/data/weiweidu/line_summarization_single_lines/trained_weights/trainevalset_pretrain_finetune_large_model/two_dimensional_bert_transformer_e{model_epoch}.pth"
    else:
        model_weight_path = f"/data/weiweidu/line_summarization_single_lines/trained_weights/trainevalset_pretrain_finetune_large_model_iterative/two_dimensional_bert_transformer_e{model_epoch}.pth"
